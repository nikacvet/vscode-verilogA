...
// let documentCompiler: VerilogACompiler;
let documentCompiler: VerilogACompiler;
...
const compilerConfigurationsKeys: string[] = [
    ...
    'veriloga.compileOnSave',
    'veriloga.launchConfigurationVerilator',
    'veriloga.launchConfigurationVCS',
    'veriloga.launchConfigurationVerible',
    'veriloga.antlrVerification',
    'veriloga.verifyOnOpen',
    'veriloga.excludeCompiling',
    'veriloga.compileOnOpen'
];
...
connection.onNotification('workspaceRootPath', (rootPath: string) => {
    documentCompiler = new VerilogACompiler(
        connection,
        documents,
        rootPath,
        configurations,
