...
// prettier-ignore
export class VerilogAFormatProvider implements vscode.DocumentFormattingEditProvider, vscode.DocumentRangeFormattingEditProvider {
    ...
    private getFormatCommand() {
        const config = vscode.workspace.getConfiguration('veriloga');
