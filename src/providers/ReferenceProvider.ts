...
import { VerilogADefinitionProvider } from './DefinitionProvider';

export class VerilogAReferenceProvider implements ReferenceProvider {
    public definitionProvider: VerilogADefinitionProvider;
